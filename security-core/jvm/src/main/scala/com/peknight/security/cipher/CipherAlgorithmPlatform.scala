...
trait CipherAlgorithmPlatform { self: CipherAlgorithm =>
  ...
  def keyCrypto[F[_]: Sync](opmode: Opmode, key: Key, input: Option[ByteVector] = None,
  ...
  def keyEncrypt[F[_]: Sync](key: Key, input: Option[ByteVector] = None,
                             params: Option[AlgorithmParameterSpec | AlgorithmParameters] = None,
                             random: Option[SecureRandom] = None, provider: Option[Provider | JProvider] = None)
  : F[ByteVector] =
    Cipher.keyEncrypt[F](self, key, input, params, random, provider)

  def keyDecrypt[F[_]: Sync](key: Key, input: Option[ByteVector] = None,
                             params: Option[AlgorithmParameterSpec | AlgorithmParameters] = None,
                             random: Option[SecureRandom] = None, provider: Option[Provider | JProvider] = None)
  : F[ByteVector] =
  ...
  def certificateCrypto[F[_]: Sync](opmode: Opmode, certificate: Certificate, input: Option[ByteVector] = None,
                                    random: Option[SecureRandom] = None, provider: Option[Provider | JProvider] = None)
  : F[ByteVector] =
    Cipher.certificateCrypto[F](self, opmode, certificate, input, random, provider)

  def certificateEncrypt[F[_]: Sync](certificate: Certificate, input: Option[ByteVector] = None,
                                     random: Option[SecureRandom] = None, provider: Option[Provider | JProvider] = None)
  : F[ByteVector] =
    Cipher.certificateEncrypt[F](self, certificate, input, random, provider)

  def certificateDecrypt[F[_]: Sync](certificate: Certificate, input: Option[ByteVector] = None,
                                     random: Option[SecureRandom] = None, provider: Option[Provider | JProvider] = None)
  : F[ByteVector] =
