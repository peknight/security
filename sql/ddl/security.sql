...
CREATE TABLE `app_crypto` (
  `cpt_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `sub_user_id` bigint(20) unsigned NOT NULL COMMENT '账号ID',
  ...
  `pwd_length` int(11) unsigned DEFAULT NULL COMMENT '密码长度',
  `pwd_complexity` tinyint(4) unsigned DEFAULT NULL COMMENT '密码复杂度',
  `pwd_time` datetime DEFAULT NULL COMMENT '操作时间',
  `remark` varchar(255) DEFAULT NULL COMMENT '备注信息',
  `create_by` bigint(20) unsigned DEFAULT NULL COMMENT '创建者',
  `gmt_create` datetime DEFAULT NULL COMMENT '创建时间',
  `modified_by` bigint(20) unsigned DEFAULT NULL COMMENT '更新者',
  `gmt_modified` datetime DEFAULT NULL COMMENT '更新时间',
  `status` tinyint(4) unsigned DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`cpt_id`),
  UNIQUE KEY `uk_uid_desc` (`sub_user_id`,`user_app_desc`) USING BTREE COMMENT '用户ID&应用描述唯一联合索引'
) DEFAULT CHARSET=utf8mb4 COMMENT='应用加密信息表';
...
CREATE TABLE `sys_application` (
  ...
  `org_id` bigint(20) unsigned DEFAULT NULL COMMENT '应用所属组织ID',
  `app_type` bigint(20) unsigned DEFAULT NULL COMMENT '应用类别',
  `parent_app_id` bigint(20) unsigned DEFAULT NULL COMMENT '父应用ID',
  `remark` varchar(255) DEFAULT NULL COMMENT '备注信息',
  `create_by` bigint(20) unsigned DEFAULT NULL COMMENT '创建者',
  `gmt_create` datetime DEFAULT NULL COMMENT '创建时间',
  `modified_by` bigint(20) unsigned DEFAULT NULL COMMENT '更新者',
...
CREATE TABLE `sys_character` (
  `c_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `c_world` bigint(4) unsigned DEFAULT NULL COMMENT '所属世界',
  `c_species` bigint(20) unsigned DEFAULT NULL COMMENT '类型',
  ...
  `c_father_id` bigint(20) unsigned DEFAULT NULL COMMENT '父亲ID',
  `c_mother_id` bigint(20) unsigned DEFAULT NULL COMMENT '母亲ID',
  `remark` varchar(255) DEFAULT NULL COMMENT '备注信息',
  `create_by` bigint(20) unsigned DEFAULT NULL COMMENT '创建者',
  `gmt_create` datetime DEFAULT NULL COMMENT '创建时间',
  `modified_by` bigint(20) unsigned DEFAULT NULL COMMENT '更新者',
  ...
  `status` tinyint(4) unsigned DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`c_id`)
) DEFAULT CHARSET=utf8mb4 COMMENT='生物表';
...
CREATE TABLE `sys_object` (
  `obj_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `obj_world` bigint(20) unsigned DEFAULT NULL COMMENT '所属世界',
  ...
  `status` tinyint(4) unsigned DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`obj_id`)
) DEFAULT CHARSET=utf8mb4 COMMENT='对象表';
...
CREATE TABLE `sys_organization` (
  `org_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `org_world` bigint(20) unsigned DEFAULT NULL COMMENT '所属世界',
  `org_type` bigint(20) unsigned DEFAULT NULL COMMENT '组织类别',
  ...
  `parent_org_id` bigint(20) unsigned DEFAULT NULL COMMENT '上级组织ID',
  `remark` varchar(255) DEFAULT NULL COMMENT '备注信息',
  `create_by` bigint(20) unsigned DEFAULT NULL COMMENT '创建者',
  `gmt_create` datetime DEFAULT NULL COMMENT '创建时间',
  `modified_by` bigint(20) unsigned DEFAULT NULL COMMENT '更新者',
...
CREATE TABLE `sys_sub_user` (
  `sub_user_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `user_id` bigint(20) unsigned DEFAULT NULL COMMENT '主账号ID',
  `app_id` bigint(20) unsigned DEFAULT NULL COMMENT '所属应用ID',
  `sub_user_flag` tinyint(4) unsigned DEFAULT NULL COMMENT '子账号标志信息',
  ...
  `parent_suser_id` bigint(20) unsigned DEFAULT NULL COMMENT '父账号ID',
  `remark` varchar(255) DEFAULT NULL COMMENT '备注信息',
  `create_by` bigint(20) unsigned DEFAULT NULL COMMENT '创建者',
  `gmt_create` datetime DEFAULT NULL COMMENT '创建时间',
  `modified_by` bigint(20) unsigned DEFAULT NULL COMMENT '更新者',
  ...
  KEY `idx_user_app` (`sub_user_name`,`app_id`,`sub_user_flag`) USING BTREE,
  KEY `idx_email_app` (`sub_user_email`,`app_id`,`sub_user_flag`) USING BTREE,
  KEY `idx_phone_app` (`sub_user_phone`,`app_id`,`sub_user_flag`) USING BTREE
) DEFAULT CHARSET=utf8mb4 COMMENT='子账号表';
...
CREATE TABLE `sys_user` (
  ...
  `c_id` bigint(20) unsigned DEFAULT NULL COMMENT 'Character ID',
